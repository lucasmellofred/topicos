 ...
 * pedidosCollection.updateOne(new Document("_id", id), new Document("$set",
 * update));
 * }
 * 
 * // Delete
 ...
 * 
 * public static void main(String[] args) {
 * PedidoService service = new PedidoService("mongodb://localhost:27017",
 * "vendetudo");
 * 
 * // Create example
 * Document pedido = new Document()
 * .append("clienteId", new ObjectId())
 * .append("dataTime", new java.util.Date())
